        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    ...
                    <p class="font-size-14 font-rale text-white-50">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Saepe, ducimus.</p>
                </div>
    ...
    <div class="copyright text-center bg-dark text-white py-2">
        <p class="font-rale font-size-14">&copy;Copyrights 2020. Design by <a href="#" class="color-second">Adebayo Onuchukwu</a></p>
    </div>
    <!-- end of footer -->
